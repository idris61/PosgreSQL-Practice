...
(                                                                                           
id serial primary key, -- serial id yi auto incremet gibi otomatik arttırır.                                                                      
isim varchar(20),                                                                             
yas int,                                                                                      
maas int,                                                                                     
email varchar(30)                                                                             
...
select * from personel where isim ilike 'a%'; -- % işareti ne ile devam ederse etsin // ilike --> A/a farkı olmasın diye
